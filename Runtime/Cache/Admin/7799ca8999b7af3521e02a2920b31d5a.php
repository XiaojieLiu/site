...
<body style="" screen_capture_injected="true">
    ...
    <div class="g-wrap">
        ...
        <div class="u-tab">
            <ul class="cc">
              <li class="current"><a href="javascript:;">[<?php echo get_model_by_id($model_id);?>] 属性列表(不含继承属性)</a></li>
            </ul>
        </div>
            ...
            <tbody>
                <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="<?php echo U('Attribute/edit?id='.$vo['id']);?>">编辑</a>
                        <a class="confirm J_ajax_get" href="<?php echo U('Attribute/remove?id='.$vo['id']);?>">删除</a>
                        </td>
        ...
        <div class="btn_wrap">
            <div class="btn_wrap_pd">
                <a class="btn btn_submit" href="<?php echo U('Attribute/add?model_id='.$model_id);?>">新 增</a>
            </div>
        </div>
        <!-- 分页 -->
        <div class="page">
